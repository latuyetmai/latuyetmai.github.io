...
|                              **Skills**                             |                                            **Tools**                                          |                           **Topics**                          |
|---------------------------------------------------------------------|:---------------------------------------------------------------------------------------------:|---------------------------------------------------------------|
|                    Machine Learning Operations (MLOps)             |                     Kubernetes<br>Docker<br>FastAPI<br>K6<br>AKS                           |             [Full End-to-End Machine Learning API](https://github.com/latuyetmai/mla-folio/tree/projects/MLOps_Ful_End_to_End_ML_API)           |
